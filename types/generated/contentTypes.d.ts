...
export interface ApiNurseNurse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::nurse.nurse'> &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String;
    nurses_teams: Schema.Attribute.Relation<
      'manyToMany',
      'api::service.service'
    >;
    ...
    SkillOne: Schema.Attribute.String;
    SkillThree: Schema.Attribute.String;
    SkillTwo: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    services: Schema.Attribute.Relation<'manyToMany', 'api::nurse.nurse'>;
